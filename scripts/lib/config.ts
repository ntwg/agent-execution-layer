...
export const DEFAULT_ORCHESTRATION_DIRECTORY = `${AEL_DIRECTORY}/orchestration`;
export const DEFAULT_ORCHESTRATION_RUNS_DIRECTORY = `${DEFAULT_ORCHESTRATION_DIRECTORY}/runs`;
export const DEFAULT_ORCHESTRATION_CHILDREN_DIRECTORY = `${DEFAULT_ORCHESTRATION_DIRECTORY}/children`;
export const DEFAULT_ORCHESTRATION_EVENTS_DIRECTORY = `${DEFAULT_ORCHESTRATION_DIRECTORY}/events`;
